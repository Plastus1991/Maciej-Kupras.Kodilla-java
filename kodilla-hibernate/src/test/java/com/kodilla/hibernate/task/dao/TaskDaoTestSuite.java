...
public class TaskDaoTestSuite {
    ...
    void testTaskDaoSaveWithFinancialDetails() {
        ...
        task.setTaskFinancialDetails(new TaskFinancialDetails(new BigDecimal(123), false));
    ...
    void testTaskListDaoSaveWithTasks() {
        ...
        TaskList taskList = new TaskList("LISTNAME", "To do task");
    ...
    void testNamedQueries() {
        ...
        List<Task> durationLongerThenTask = taskDao.retrieveTasksWithDurationLongerThan(6);
